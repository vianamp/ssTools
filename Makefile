...
debug: ssTools.cpp
	@$(CC) $(DFLAG) $(CFLAGS) ssTools.cpp -o ssTools $(VTK_DYN_LIBS) -I$(VTK_INCLUDE_DIR)

dynamic: ssTools.cpp
	@$(CC) $(CFLAGS) ssTools.cpp -o ssTools $(VTK_DYN_LIBS) -I$(VTK_INCLUDE_DIR)

static:
	@$(CC) $(CFLAGS) ssTools.cpp -o ssTools $(VTK_STA_LIBS) -I$(VTK_INCLUDE_DIR)